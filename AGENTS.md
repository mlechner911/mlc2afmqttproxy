...
- **Source directory:** `/mnt/data2tb/mlc2afmqttproxy` (read source files with native Read —
...
- **Use the project id `mlc2afmqttproxy`.** Never invent `mlc2afmqttproxy-mac`, and
